...
*                 DatabaseTask_event.
*-----------------------------------------------------------------------------
* $Date: 2011-02-21 15:41:31 +0100 (Mo, 21 Feb 2011) $
* $Rev: 18064 $
* $Author: weber $
* $URL: http://subversion-01/svn/SW_HW_System/Projects/Ford_SCM/SW/MOD/SYS_OSEK_INTERFACE/trunk/src/OSEK_DatabaseTask_C1.c $
*-----------------------------------------------------------------------------
*/
/******************************************************************************/
...
SuccessFailType InitDatabaseTask(void)
{
	...
	(void)SetRelAlarm(CTA_WD, MSEC(2), MSEC(10));
