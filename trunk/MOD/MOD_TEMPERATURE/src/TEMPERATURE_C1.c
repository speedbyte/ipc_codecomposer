...
* $Rev: 13282 $
* $Author: agrawal $
* $URL: http://subversion-01/svn/SW_HW_System/Projects/Ford_SCM/SW/MOD/MOD_TEMPERATURE/trunk/src/TEMPERATURE_C1.c $
*-----------------------------------------------------------------------------
*/
/******************************************************************************/
...
static Uint8Type _TEMPERATURE_u8ConvertTemperature(Uint16Type u16ADC_Value)
{
    ...
    return (_TEMPERATURE_TableValues[i].Temperature);
}
