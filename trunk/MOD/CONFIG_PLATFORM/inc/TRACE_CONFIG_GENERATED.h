...
#endif
#if (1 == APP_CONNECTION_SWI_ERR)
    #define APP_CONNECTION_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_CONNECTION_SWI_WNG)
    #define APP_CONNECTION_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_CONNECTION_SWI_TRC)
    #define APP_CONNECTION_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_CONNECTION_SWI_DBG)
    #define APP_CONNECTION_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == EEPROM_LAYOUT_CFG_SWI_ERR)
    #define EEPROM_LAYOUT_CFG_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define EEPROM_LAYOUT_CFG_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define EEPROM_LAYOUT_CFG_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define EEPROM_LAYOUT_CFG_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define EEPROM_LAYOUT_CFG_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define EEPROM_LAYOUT_CFG_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define EEPROM_LAYOUT_CFG_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define EEPROM_LAYOUT_CFG_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define EEPROM_LAYOUT_CFG_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define EEPROM_LAYOUT_CFG_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define EEPROM_LAYOUT_CFG_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define EEPROM_LAYOUT_CFG_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define EEPROM_LAYOUT_CFG_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define EEPROM_LAYOUT_CFG_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define EEPROM_LAYOUT_CFG_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define EEPROM_LAYOUT_CFG_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == EEPROM_LAYOUT_CFG_SWI_WNG)
    #define EEPROM_LAYOUT_CFG_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define EEPROM_LAYOUT_CFG_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define EEPROM_LAYOUT_CFG_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define EEPROM_LAYOUT_CFG_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define EEPROM_LAYOUT_CFG_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define EEPROM_LAYOUT_CFG_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define EEPROM_LAYOUT_CFG_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define EEPROM_LAYOUT_CFG_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define EEPROM_LAYOUT_CFG_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define EEPROM_LAYOUT_CFG_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define EEPROM_LAYOUT_CFG_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define EEPROM_LAYOUT_CFG_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define EEPROM_LAYOUT_CFG_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define EEPROM_LAYOUT_CFG_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define EEPROM_LAYOUT_CFG_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define EEPROM_LAYOUT_CFG_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == EEPROM_LAYOUT_CFG_SWI_TRC)
    #define EEPROM_LAYOUT_CFG_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define EEPROM_LAYOUT_CFG_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define EEPROM_LAYOUT_CFG_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define EEPROM_LAYOUT_CFG_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define EEPROM_LAYOUT_CFG_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define EEPROM_LAYOUT_CFG_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define EEPROM_LAYOUT_CFG_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define EEPROM_LAYOUT_CFG_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define EEPROM_LAYOUT_CFG_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define EEPROM_LAYOUT_CFG_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define EEPROM_LAYOUT_CFG_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define EEPROM_LAYOUT_CFG_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define EEPROM_LAYOUT_CFG_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define EEPROM_LAYOUT_CFG_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define EEPROM_LAYOUT_CFG_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define EEPROM_LAYOUT_CFG_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == EEPROM_LAYOUT_CFG_SWI_DBG)
    #define EEPROM_LAYOUT_CFG_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define EEPROM_LAYOUT_CFG_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define EEPROM_LAYOUT_CFG_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define EEPROM_LAYOUT_CFG_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define EEPROM_LAYOUT_CFG_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define EEPROM_LAYOUT_CFG_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define EEPROM_LAYOUT_CFG_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define EEPROM_LAYOUT_CFG_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define EEPROM_LAYOUT_CFG_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define EEPROM_LAYOUT_CFG_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define EEPROM_LAYOUT_CFG_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define EEPROM_LAYOUT_CFG_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define EEPROM_LAYOUT_CFG_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define EEPROM_LAYOUT_CFG_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define EEPROM_LAYOUT_CFG_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define EEPROM_LAYOUT_CFG_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
...
#endif
#if (1 == APP_INFO_SWI_ERR)
    #define APP_INFO_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_INFO_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_INFO_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_INFO_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_INFO_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_INFO_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_INFO_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_INFO_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_INFO_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define APP_INFO_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define APP_INFO_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_INFO_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_INFO_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define APP_INFO_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define APP_INFO_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_INFO_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_INFO_SWI_WNG)
    #define APP_INFO_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_INFO_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_INFO_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_INFO_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_INFO_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_INFO_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_INFO_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_INFO_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_INFO_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define APP_INFO_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define APP_INFO_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_INFO_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_INFO_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define APP_INFO_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define APP_INFO_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_INFO_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_INFO_SWI_TRC)
    #define APP_INFO_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_INFO_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_INFO_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_INFO_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_INFO_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_INFO_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_INFO_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_INFO_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_INFO_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define APP_INFO_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define APP_INFO_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_INFO_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_INFO_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define APP_INFO_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define APP_INFO_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_INFO_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_INFO_SWI_DBG)
    #define APP_INFO_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_INFO_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_INFO_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_INFO_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_INFO_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_INFO_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_INFO_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_INFO_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_INFO_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define APP_INFO_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define APP_INFO_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_INFO_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_INFO_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define APP_INFO_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define APP_INFO_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_INFO_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_MDI_RX_CAN_SWI_ERR)
    #define APP_MDI_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_MDI_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_MDI_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_MDI_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_MDI_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_MDI_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_MDI_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_MDI_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_MDI_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define APP_MDI_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define APP_MDI_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_MDI_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_MDI_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define APP_MDI_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define APP_MDI_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_MDI_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_MDI_RX_CAN_SWI_WNG)
    #define APP_MDI_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_MDI_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_MDI_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_MDI_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_MDI_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_MDI_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_MDI_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_MDI_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_MDI_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define APP_MDI_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define APP_MDI_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_MDI_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_MDI_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define APP_MDI_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define APP_MDI_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_MDI_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_MDI_RX_CAN_SWI_TRC)
    #define APP_MDI_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_MDI_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_MDI_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_MDI_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_MDI_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_MDI_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_MDI_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_MDI_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_MDI_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define APP_MDI_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define APP_MDI_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_MDI_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_MDI_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define APP_MDI_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define APP_MDI_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_MDI_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_MDI_RX_CAN_SWI_DBG)
    #define APP_MDI_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_MDI_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_MDI_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_MDI_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_MDI_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_MDI_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_MDI_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_MDI_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_MDI_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define APP_MDI_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define APP_MDI_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_MDI_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_MDI_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define APP_MDI_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define APP_MDI_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_MDI_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
...
#endif
#if (1 == IPC_SWI_ERR)
    #define IPC_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define IPC_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define IPC_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define IPC_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define IPC_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define IPC_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define IPC_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define IPC_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define IPC_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define IPC_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define IPC_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define IPC_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define IPC_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define IPC_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define IPC_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define IPC_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == IPC_SWI_WNG)
    #define IPC_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define IPC_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define IPC_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define IPC_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define IPC_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define IPC_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define IPC_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define IPC_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define IPC_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define IPC_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define IPC_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define IPC_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define IPC_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define IPC_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define IPC_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define IPC_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == IPC_SWI_TRC)
    #define IPC_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define IPC_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define IPC_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define IPC_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define IPC_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define IPC_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define IPC_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define IPC_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define IPC_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define IPC_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define IPC_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define IPC_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define IPC_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define IPC_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define IPC_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define IPC_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == IPC_SWI_DBG)
    #define IPC_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define IPC_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define IPC_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define IPC_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define IPC_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define IPC_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define IPC_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define IPC_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define IPC_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define IPC_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define IPC_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define IPC_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define IPC_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define IPC_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define IPC_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define IPC_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_MDI_TX_CAN_SWI_ERR)
    #define APP_MDI_TX_CAN_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_MDI_TX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_MDI_TX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_MDI_TX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_MDI_TX_CAN_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_MDI_TX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_MDI_TX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_MDI_TX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_MDI_TX_CAN_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define APP_MDI_TX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define APP_MDI_TX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_MDI_TX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_MDI_TX_CAN_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define APP_MDI_TX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define APP_MDI_TX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_MDI_TX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_MDI_TX_CAN_SWI_WNG)
    #define APP_MDI_TX_CAN_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_MDI_TX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_MDI_TX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_MDI_TX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_MDI_TX_CAN_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_MDI_TX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_MDI_TX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_MDI_TX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_MDI_TX_CAN_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define APP_MDI_TX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define APP_MDI_TX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_MDI_TX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_MDI_TX_CAN_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define APP_MDI_TX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define APP_MDI_TX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_MDI_TX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_MDI_TX_CAN_SWI_TRC)
    #define APP_MDI_TX_CAN_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_MDI_TX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_MDI_TX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_MDI_TX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_MDI_TX_CAN_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_MDI_TX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_MDI_TX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_MDI_TX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_MDI_TX_CAN_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define APP_MDI_TX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define APP_MDI_TX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_MDI_TX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_MDI_TX_CAN_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define APP_MDI_TX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define APP_MDI_TX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_MDI_TX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_MDI_TX_CAN_SWI_DBG)
    #define APP_MDI_TX_CAN_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_MDI_TX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_MDI_TX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_MDI_TX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_MDI_TX_CAN_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_MDI_TX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_MDI_TX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_MDI_TX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_MDI_TX_CAN_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define APP_MDI_TX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define APP_MDI_TX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_MDI_TX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_MDI_TX_CAN_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define APP_MDI_TX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define APP_MDI_TX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_MDI_TX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_PHONE_RX_CAN_SWI_ERR)
    #define APP_PHONE_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_PHONE_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_PHONE_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_PHONE_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_PHONE_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_PHONE_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_PHONE_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_PHONE_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_PHONE_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define APP_PHONE_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define APP_PHONE_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_PHONE_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_PHONE_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define APP_PHONE_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define APP_PHONE_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_PHONE_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_PHONE_RX_CAN_SWI_WNG)
    #define APP_PHONE_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_PHONE_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_PHONE_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_PHONE_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_PHONE_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_PHONE_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_PHONE_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_PHONE_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_PHONE_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define APP_PHONE_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define APP_PHONE_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_PHONE_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_PHONE_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define APP_PHONE_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define APP_PHONE_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_PHONE_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_PHONE_RX_CAN_SWI_TRC)
    #define APP_PHONE_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_PHONE_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_PHONE_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_PHONE_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_PHONE_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_PHONE_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_PHONE_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_PHONE_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_PHONE_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define APP_PHONE_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define APP_PHONE_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_PHONE_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_PHONE_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define APP_PHONE_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define APP_PHONE_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_PHONE_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_PHONE_RX_CAN_SWI_DBG)
    #define APP_PHONE_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_PHONE_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_PHONE_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_PHONE_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_PHONE_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_PHONE_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_PHONE_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_PHONE_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_PHONE_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define APP_PHONE_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define APP_PHONE_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_PHONE_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_PHONE_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define APP_PHONE_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define APP_PHONE_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_PHONE_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_PHONE_TX_CAN_SWI_ERR)
    #define APP_PHONE_TX_CAN_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_PHONE_TX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_PHONE_TX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_PHONE_TX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_PHONE_TX_CAN_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_PHONE_TX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_PHONE_TX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_PHONE_TX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_PHONE_TX_CAN_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define APP_PHONE_TX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define APP_PHONE_TX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_PHONE_TX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_PHONE_TX_CAN_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define APP_PHONE_TX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define APP_PHONE_TX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_PHONE_TX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_PHONE_TX_CAN_SWI_WNG)
    #define APP_PHONE_TX_CAN_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_PHONE_TX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_PHONE_TX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_PHONE_TX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_PHONE_TX_CAN_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_PHONE_TX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_PHONE_TX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_PHONE_TX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_PHONE_TX_CAN_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define APP_PHONE_TX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define APP_PHONE_TX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_PHONE_TX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_PHONE_TX_CAN_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define APP_PHONE_TX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define APP_PHONE_TX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_PHONE_TX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_PHONE_TX_CAN_SWI_TRC)
    #define APP_PHONE_TX_CAN_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_PHONE_TX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_PHONE_TX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_PHONE_TX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_PHONE_TX_CAN_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_PHONE_TX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_PHONE_TX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_PHONE_TX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_PHONE_TX_CAN_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define APP_PHONE_TX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define APP_PHONE_TX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_PHONE_TX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_PHONE_TX_CAN_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define APP_PHONE_TX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define APP_PHONE_TX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_PHONE_TX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_PHONE_TX_CAN_SWI_DBG)
    #define APP_PHONE_TX_CAN_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_PHONE_TX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_PHONE_TX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_PHONE_TX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_PHONE_TX_CAN_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_PHONE_TX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_PHONE_TX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_PHONE_TX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_PHONE_TX_CAN_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define APP_PHONE_TX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define APP_PHONE_TX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_PHONE_TX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_PHONE_TX_CAN_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define APP_PHONE_TX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define APP_PHONE_TX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_PHONE_TX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
...
#endif
#if (1 == APP_CONNECTION_RX_CAN_SWI_ERR)
    #define APP_CONNECTION_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_CONNECTION_RX_CAN_SWI_WNG)
    #define APP_CONNECTION_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_CONNECTION_RX_CAN_SWI_TRC)
    #define APP_CONNECTION_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_CONNECTION_RX_CAN_SWI_DBG)
    #define APP_CONNECTION_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_CONNECTION_TX_CAN_SWI_ERR)
    #define APP_CONNECTION_TX_CAN_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_TX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_TX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_TX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_TX_CAN_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_TX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_TX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_TX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_TX_CAN_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_TX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_TX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_TX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_TX_CAN_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_TX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_TX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_TX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_CONNECTION_TX_CAN_SWI_WNG)
    #define APP_CONNECTION_TX_CAN_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_TX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_TX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_TX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_TX_CAN_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_TX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_TX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_TX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_TX_CAN_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_TX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_TX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_TX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_TX_CAN_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_TX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_TX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_TX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_CONNECTION_TX_CAN_SWI_TRC)
    #define APP_CONNECTION_TX_CAN_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_TX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_TX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_TX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_TX_CAN_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_TX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_TX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_TX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_TX_CAN_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_TX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_TX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_TX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_TX_CAN_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_TX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_TX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_TX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == APP_CONNECTION_TX_CAN_SWI_DBG)
    #define APP_CONNECTION_TX_CAN_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define APP_CONNECTION_TX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define APP_CONNECTION_TX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define APP_CONNECTION_TX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define APP_CONNECTION_TX_CAN_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define APP_CONNECTION_TX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define APP_CONNECTION_TX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define APP_CONNECTION_TX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define APP_CONNECTION_TX_CAN_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define APP_CONNECTION_TX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define APP_CONNECTION_TX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define APP_CONNECTION_TX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define APP_CONNECTION_TX_CAN_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define APP_CONNECTION_TX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define APP_CONNECTION_TX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define APP_CONNECTION_TX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == CRC_SWI_ERR)
...
#endif
#if (1 == DIAG_SWI_ERR)
    #define DIAG_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define DIAG_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define DIAG_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define DIAG_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define DIAG_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define DIAG_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define DIAG_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define DIAG_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define DIAG_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define DIAG_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define DIAG_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define DIAG_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define DIAG_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define DIAG_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define DIAG_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define DIAG_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == DIAG_SWI_WNG)
    #define DIAG_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define DIAG_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define DIAG_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define DIAG_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define DIAG_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define DIAG_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define DIAG_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define DIAG_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define DIAG_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define DIAG_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define DIAG_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define DIAG_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define DIAG_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define DIAG_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define DIAG_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define DIAG_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == DIAG_SWI_TRC)
    #define DIAG_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define DIAG_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define DIAG_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define DIAG_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define DIAG_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define DIAG_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define DIAG_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define DIAG_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define DIAG_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define DIAG_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define DIAG_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define DIAG_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define DIAG_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define DIAG_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define DIAG_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define DIAG_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == DIAG_SWI_DBG)
    #define DIAG_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define DIAG_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define DIAG_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define DIAG_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define DIAG_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define DIAG_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define DIAG_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define DIAG_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define DIAG_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define DIAG_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define DIAG_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define DIAG_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define DIAG_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define DIAG_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define DIAG_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define DIAG_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == EEPROM_SWI_ERR)
...
#endif
#if (1 == GPS_UBX_SWI_ERR)
    #define GPS_UBX_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define GPS_UBX_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define GPS_UBX_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define GPS_UBX_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define GPS_UBX_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define GPS_UBX_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define GPS_UBX_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define GPS_UBX_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define GPS_UBX_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define GPS_UBX_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define GPS_UBX_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define GPS_UBX_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define GPS_UBX_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define GPS_UBX_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define GPS_UBX_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define GPS_UBX_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == GPS_UBX_SWI_WNG)
    #define GPS_UBX_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define GPS_UBX_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define GPS_UBX_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define GPS_UBX_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define GPS_UBX_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define GPS_UBX_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define GPS_UBX_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define GPS_UBX_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define GPS_UBX_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define GPS_UBX_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define GPS_UBX_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define GPS_UBX_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define GPS_UBX_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define GPS_UBX_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define GPS_UBX_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define GPS_UBX_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == GPS_UBX_SWI_TRC)
    #define GPS_UBX_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define GPS_UBX_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define GPS_UBX_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define GPS_UBX_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define GPS_UBX_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define GPS_UBX_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define GPS_UBX_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define GPS_UBX_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define GPS_UBX_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define GPS_UBX_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define GPS_UBX_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define GPS_UBX_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define GPS_UBX_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define GPS_UBX_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define GPS_UBX_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define GPS_UBX_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == GPS_UBX_SWI_DBG)
    #define GPS_UBX_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define GPS_UBX_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define GPS_UBX_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define GPS_UBX_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define GPS_UBX_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define GPS_UBX_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define GPS_UBX_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define GPS_UBX_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define GPS_UBX_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define GPS_UBX_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define GPS_UBX_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define GPS_UBX_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define GPS_UBX_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define GPS_UBX_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define GPS_UBX_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define GPS_UBX_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
...
#endif
#if (1 == VCR_RX_CAN_SWI_ERR)
    #define VCR_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define VCR_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define VCR_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define VCR_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define VCR_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define VCR_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define VCR_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define VCR_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define VCR_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define VCR_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define VCR_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define VCR_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define VCR_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define VCR_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define VCR_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define VCR_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == VCR_RX_CAN_SWI_WNG)
    #define VCR_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define VCR_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define VCR_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define VCR_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define VCR_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define VCR_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define VCR_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define VCR_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define VCR_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define VCR_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define VCR_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define VCR_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define VCR_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define VCR_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define VCR_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define VCR_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == VCR_RX_CAN_SWI_TRC)
    #define VCR_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define VCR_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define VCR_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define VCR_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define VCR_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define VCR_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define VCR_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define VCR_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define VCR_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define VCR_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define VCR_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define VCR_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define VCR_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define VCR_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define VCR_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define VCR_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == VCR_RX_CAN_SWI_DBG)
    #define VCR_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define VCR_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define VCR_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define VCR_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define VCR_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define VCR_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define VCR_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define VCR_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define VCR_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define VCR_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define VCR_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define VCR_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define VCR_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define VCR_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define VCR_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define VCR_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == VCR_TX_CAN_SWI_ERR)
    #define VCR_TX_CAN_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define VCR_TX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define VCR_TX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define VCR_TX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define VCR_TX_CAN_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define VCR_TX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define VCR_TX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define VCR_TX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define VCR_TX_CAN_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define VCR_TX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define VCR_TX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define VCR_TX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define VCR_TX_CAN_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define VCR_TX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define VCR_TX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define VCR_TX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == VCR_TX_CAN_SWI_WNG)
    #define VCR_TX_CAN_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define VCR_TX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define VCR_TX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define VCR_TX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define VCR_TX_CAN_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define VCR_TX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define VCR_TX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define VCR_TX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define VCR_TX_CAN_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define VCR_TX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define VCR_TX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define VCR_TX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define VCR_TX_CAN_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define VCR_TX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define VCR_TX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define VCR_TX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == VCR_TX_CAN_SWI_TRC)
    #define VCR_TX_CAN_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define VCR_TX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define VCR_TX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define VCR_TX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define VCR_TX_CAN_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define VCR_TX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define VCR_TX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define VCR_TX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define VCR_TX_CAN_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define VCR_TX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define VCR_TX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define VCR_TX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define VCR_TX_CAN_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define VCR_TX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define VCR_TX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define VCR_TX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == VCR_TX_CAN_SWI_DBG)
    #define VCR_TX_CAN_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define VCR_TX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define VCR_TX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define VCR_TX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define VCR_TX_CAN_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define VCR_TX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define VCR_TX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define VCR_TX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define VCR_TX_CAN_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define VCR_TX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define VCR_TX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define VCR_TX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define VCR_TX_CAN_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define VCR_TX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define VCR_TX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define VCR_TX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == VCR_SWI_ERR)
...
#endif
#if (1 == SCM_CONFIG_RX_CAN_SWI_ERR)
    #define SCM_CONFIG_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define SCM_CONFIG_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define SCM_CONFIG_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define SCM_CONFIG_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define SCM_CONFIG_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define SCM_CONFIG_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define SCM_CONFIG_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define SCM_CONFIG_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define SCM_CONFIG_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define SCM_CONFIG_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define SCM_CONFIG_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define SCM_CONFIG_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define SCM_CONFIG_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define SCM_CONFIG_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define SCM_CONFIG_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define SCM_CONFIG_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == SCM_CONFIG_RX_CAN_SWI_WNG)
    #define SCM_CONFIG_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define SCM_CONFIG_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define SCM_CONFIG_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define SCM_CONFIG_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define SCM_CONFIG_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define SCM_CONFIG_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define SCM_CONFIG_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define SCM_CONFIG_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define SCM_CONFIG_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define SCM_CONFIG_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define SCM_CONFIG_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define SCM_CONFIG_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define SCM_CONFIG_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define SCM_CONFIG_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define SCM_CONFIG_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define SCM_CONFIG_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == SCM_CONFIG_RX_CAN_SWI_TRC)
    #define SCM_CONFIG_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define SCM_CONFIG_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define SCM_CONFIG_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define SCM_CONFIG_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define SCM_CONFIG_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define SCM_CONFIG_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define SCM_CONFIG_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define SCM_CONFIG_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define SCM_CONFIG_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define SCM_CONFIG_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define SCM_CONFIG_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define SCM_CONFIG_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define SCM_CONFIG_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define SCM_CONFIG_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define SCM_CONFIG_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define SCM_CONFIG_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == SCM_CONFIG_RX_CAN_SWI_DBG)
    #define SCM_CONFIG_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define SCM_CONFIG_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define SCM_CONFIG_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define SCM_CONFIG_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define SCM_CONFIG_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define SCM_CONFIG_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define SCM_CONFIG_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define SCM_CONFIG_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define SCM_CONFIG_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define SCM_CONFIG_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define SCM_CONFIG_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define SCM_CONFIG_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define SCM_CONFIG_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define SCM_CONFIG_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define SCM_CONFIG_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define SCM_CONFIG_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == SCM_CONFIG_TX_CAN_SWI_ERR)
    #define SCM_CONFIG_TX_CAN_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define SCM_CONFIG_TX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define SCM_CONFIG_TX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define SCM_CONFIG_TX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define SCM_CONFIG_TX_CAN_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define SCM_CONFIG_TX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define SCM_CONFIG_TX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define SCM_CONFIG_TX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define SCM_CONFIG_TX_CAN_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define SCM_CONFIG_TX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define SCM_CONFIG_TX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define SCM_CONFIG_TX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define SCM_CONFIG_TX_CAN_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define SCM_CONFIG_TX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define SCM_CONFIG_TX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define SCM_CONFIG_TX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == SCM_CONFIG_TX_CAN_SWI_WNG)
    #define SCM_CONFIG_TX_CAN_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define SCM_CONFIG_TX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define SCM_CONFIG_TX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define SCM_CONFIG_TX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define SCM_CONFIG_TX_CAN_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define SCM_CONFIG_TX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define SCM_CONFIG_TX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define SCM_CONFIG_TX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define SCM_CONFIG_TX_CAN_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define SCM_CONFIG_TX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define SCM_CONFIG_TX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define SCM_CONFIG_TX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define SCM_CONFIG_TX_CAN_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define SCM_CONFIG_TX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define SCM_CONFIG_TX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define SCM_CONFIG_TX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == SCM_CONFIG_TX_CAN_SWI_TRC)
    #define SCM_CONFIG_TX_CAN_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define SCM_CONFIG_TX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define SCM_CONFIG_TX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define SCM_CONFIG_TX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define SCM_CONFIG_TX_CAN_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define SCM_CONFIG_TX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define SCM_CONFIG_TX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define SCM_CONFIG_TX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define SCM_CONFIG_TX_CAN_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define SCM_CONFIG_TX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define SCM_CONFIG_TX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define SCM_CONFIG_TX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define SCM_CONFIG_TX_CAN_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define SCM_CONFIG_TX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define SCM_CONFIG_TX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define SCM_CONFIG_TX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == SCM_CONFIG_TX_CAN_SWI_DBG)
    #define SCM_CONFIG_TX_CAN_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define SCM_CONFIG_TX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define SCM_CONFIG_TX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define SCM_CONFIG_TX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define SCM_CONFIG_TX_CAN_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define SCM_CONFIG_TX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define SCM_CONFIG_TX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define SCM_CONFIG_TX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define SCM_CONFIG_TX_CAN_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define SCM_CONFIG_TX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define SCM_CONFIG_TX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define SCM_CONFIG_TX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define SCM_CONFIG_TX_CAN_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define SCM_CONFIG_TX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define SCM_CONFIG_TX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define SCM_CONFIG_TX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == AUDIO_MANAGER_SWI_ERR)
    #define AUDIO_MANAGER_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define AUDIO_MANAGER_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define AUDIO_MANAGER_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define AUDIO_MANAGER_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define AUDIO_MANAGER_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define AUDIO_MANAGER_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define AUDIO_MANAGER_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define AUDIO_MANAGER_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define AUDIO_MANAGER_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define AUDIO_MANAGER_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define AUDIO_MANAGER_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define AUDIO_MANAGER_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define AUDIO_MANAGER_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define AUDIO_MANAGER_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define AUDIO_MANAGER_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define AUDIO_MANAGER_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == AUDIO_MANAGER_SWI_WNG)
    #define AUDIO_MANAGER_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define AUDIO_MANAGER_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define AUDIO_MANAGER_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define AUDIO_MANAGER_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define AUDIO_MANAGER_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define AUDIO_MANAGER_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define AUDIO_MANAGER_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define AUDIO_MANAGER_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define AUDIO_MANAGER_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define AUDIO_MANAGER_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define AUDIO_MANAGER_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define AUDIO_MANAGER_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define AUDIO_MANAGER_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define AUDIO_MANAGER_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define AUDIO_MANAGER_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define AUDIO_MANAGER_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == AUDIO_MANAGER_SWI_TRC)
    #define AUDIO_MANAGER_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define AUDIO_MANAGER_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define AUDIO_MANAGER_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define AUDIO_MANAGER_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define AUDIO_MANAGER_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define AUDIO_MANAGER_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define AUDIO_MANAGER_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define AUDIO_MANAGER_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define AUDIO_MANAGER_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define AUDIO_MANAGER_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define AUDIO_MANAGER_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define AUDIO_MANAGER_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define AUDIO_MANAGER_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define AUDIO_MANAGER_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define AUDIO_MANAGER_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define AUDIO_MANAGER_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == AUDIO_MANAGER_SWI_DBG)
    #define AUDIO_MANAGER_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define AUDIO_MANAGER_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define AUDIO_MANAGER_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define AUDIO_MANAGER_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define AUDIO_MANAGER_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define AUDIO_MANAGER_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define AUDIO_MANAGER_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define AUDIO_MANAGER_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define AUDIO_MANAGER_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define AUDIO_MANAGER_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define AUDIO_MANAGER_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define AUDIO_MANAGER_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define AUDIO_MANAGER_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define AUDIO_MANAGER_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define AUDIO_MANAGER_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define AUDIO_MANAGER_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == AUDIO_MANAGER_RX_CAN_SWI_ERR)
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_TEXT(moduleID, format)                                         {}
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_VALUE1(moduleID, format, value)                                {}
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_VALUE2(moduleID, format, value1, value2)                       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_STRING(moduleID, format, string)                               {}
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_STATE1(moduleID, format, state)                                {}
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_STATE2(moduleID, format, state1, state2)                       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_ERR_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == AUDIO_MANAGER_RX_CAN_SWI_WNG)
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_TEXT(moduleID, format)                                         {}
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_VALUE1(moduleID, format, value)                                {}
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_VALUE2(moduleID, format, value1, value2)                       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_STRING(moduleID, format, string)                               {}
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_STATE1(moduleID, format, state)                                {}
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_STATE2(moduleID, format, state1, state2)                       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_WNG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == AUDIO_MANAGER_RX_CAN_SWI_TRC)
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_TEXT(moduleID, format)                                         {}
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_VALUE1(moduleID, format, value)                                {}
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_VALUE2(moduleID, format, value1, value2)                       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_STRING(moduleID, format, string)                               {}
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_STATE1(moduleID, format, state)                                {}
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_STATE2(moduleID, format, state1, state2)                       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_TRC_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#if (1 == AUDIO_MANAGER_RX_CAN_SWI_DBG)
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         LOG_TEXT(moduleID, format)
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                LOG_VALUE1(moduleID, format, value)
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       LOG_VALUE2(moduleID, format, value1, value2)
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       LOG_VALUE4(moduleID, format, value1, value2, value3, value4)
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               LOG_STRING(moduleID, format, string)
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                LOG_STATE1(moduleID, format, state)
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       LOG_STATE2(moduleID, format, state1, state2)
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       LOG_STATE4(moduleID, format, state1, state2, state3, state4)
#else
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_TEXT(moduleID, format)                                         {}
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_VALUE1(moduleID, format, value)                                {}
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_VALUE2(moduleID, format, value1, value2)                       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_VALUE4(moduleID, format, value1, value2, value3, value4)       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_STRING(moduleID, format, string)                               {}
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_STATE1(moduleID, format, state)                                {}
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_STATE2(moduleID, format, state1, state2)                       {}
    #define AUDIO_MANAGER_RX_CAN_SWI_DBG_STATE4(moduleID, format, state1, state2, state3, state4)       {}
#endif
#endif
