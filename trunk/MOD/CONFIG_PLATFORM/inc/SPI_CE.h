...
#define SPI1_BAUD_RATE SPI_3MHZ
#define SPI2_BAUD_RATE SPI_3MHZ
#define SPI3_BAUD_RATE SPI_3MHZ

#if (defined(PROCESSOR_TMS470R1VF55BA) || defined(PROCESSOR_TMS470R1SF55BA))

#define SPI4_BAUD_RATE SPI_3MHZ
#define SPI5_BAUD_RATE SPI_3MHZ

#endif

#define SPI_INIT if ( pstSpi == (SPI_PST)SPI1 )\
        {\
            SPI_vConfigureBaudRate(pstSpi, SPI1_BAUD_RATE);\
        ...
        else if ( pstSpi == (SPI_PST)SPI2 )\
        {\
            SPI_vConfigureBaudRate(pstSpi, SPI2_BAUD_RATE);\
		    SPI_vPinModify(pstSpi, SpiEnablePin,  PortIoOutHigh);\
		    SPI_vPinModify(pstSpi, SpiClkPin,  PortFunctional);\
		    SPI_vPinModify(pstSpi, SpiSimoPin,  PortFunctional);\
		    SPI_vPinModify(pstSpi, SpiSomiPin,  PortFunctional);\
        ...
        else if ( pstSpi == (SPI_PST)SPI3 )\
        {\
            SPI_vConfigureBaudRate(pstSpi, SPI3_BAUD_RATE);\
		    SPI_vPinModify(pstSpi, SpiEnablePin,  PortIoOutHigh);\
		    SPI_vPinModify(pstSpi, SpiClkPin,  PortFunctional);\
		    SPI_vPinModify(pstSpi, SpiSimoPin,  PortFunctional);\
		    SPI_vPinModify(pstSpi, SpiSomiPin,  PortFunctional);\
        ...
        else if ( pstSpi == (SPI_PST)SPI4 )\
        {\
		    SPI_vPinModify(pstSpi, SpiEnablePin,  PortIoOutHigh);\
		    SPI_vPinModify(pstSpi, SpiClkPin,  PortIoOutLow);\
		    SPI_vPinModify(pstSpi, SpiSimoPin,  PortIoOutLow);\
		    SPI_vPinModify(pstSpi, SpiSomiPin,  PortIoOutLow);\
		    SPI_vPinModify(pstSpi, SpiScsPin,  PortIoOutHigh);\
        }\
	    ...
	    {\
		    ...
		    SPI_vPinModify(pstSpi, SpiSimoPin, PortIoOutLow);\
		    SPI_vPinModify(pstSpi, SpiSomiPin, PortIoOutLow);\
		    SPI_vPinModify(pstSpi, SpiScsPin,  PortIoIn);\
        }
