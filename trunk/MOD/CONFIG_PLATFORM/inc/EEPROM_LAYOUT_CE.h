...
/*----------------------------------------------------------------------------*/
#define FORD_SCM_EEPROM

#define EEPROM_LAYOUT_PROTECTED_TABLE \
  {PAG_DB_EE_ADDRESS_ProductionFlag, PAG_DB_EE_ADDRESS_ProductionFlag_LEN}

#define MAX_EEPROM_WRITEPROTECT_ELEM  1

#define PROTECTED_AREA_CONDITIONS (BT_TRUE == BT_FALSE)
/*----------------------------------------------------------------------------*/
/* Public Code Macros                                                         */
/*----------------------------------------------------------------------------*/
/** 
