...
* $Rev: 17648 $
* $Author: agrawal $
* $URL: http://subversion-01/svn/SW_HW_System/Projects/Ford_SCM/SW/MOD/MOD_APP_DTC/trunk/inc/APP_DTC_CE.h $
*-----------------------------------------------------------------------------
*/
/******************************************************************************/
...
typedef enum {
    APP_DTC_MICROPHONE_KURZSCHLUSSNACHMASSE_PLUS    = 196,
    APP_DTC_MICROPHONE_NOPROBLEM_PLUS_MIN           = 217,
    APP_DTC_MICROPHONE_NOPROBLEM_PLUS_MAX           = 325,
    APP_DTC_MICROPHONE_UNTERBRECHNUNG_PLUS_MIN      = 358,
    APP_DTC_MICROPHONE_UNTERBRECHNUNG_PLUS_MAX      = 624,
    APP_DTC_MICROPHONE_KURZSCHLUSSNACHPLUS_PLUS     = 625
