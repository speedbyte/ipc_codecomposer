...
/* ========================================================================== */
 ...
 #error "ERROR :: DEH variant not set! Define the flag DEH_SUP_KWP2000 or DEH_SUP_UDS!"
    ...
    /* -------------------------------------------------------------------- */
#define DEH_MAX_NUMBER_OF_EVENTPATHS  32
    ...
    /* -------------------------------------------------------------------- */
#define DEH_MAX_NUMBER_EV_MEM  20
...
/*  #define DEH_READ_ADD_FF */
    ...
    /* event.                                                               */
    /* -------------------------------------------------------------------- */
#define DEH_MAX_NUMBER_ADD_FF 0
...
typedef enum {
	DEH_EE_NOT_REGISTER   = 0x00,
	DEH_EE_REGISTER       = 0x01,
	DEH_EE_NOTHING_TODO   = 0xFF
} TriStateType_DEH_EE;

/*==========================================================================*/
/* Global Variables                                                         */
/*==========================================================================*/
extern uint8_t mon_ZvzEepromhastoWritetoEEprom;
...
extern void DEH_InitEEPROM(void);     /* damit wird der DTC-EEPROM-Bereich einmalig mit 0xFF vorbelegt */
extern void InitDEHFaultData(void);
extern void ReadZVZoutOfEEprom(void);
extern void ZVZ_EEPromWritetoEEprom(void);
extern uint8_t DEH_AdditionalReportEvent (uint8_t DEH_EventNumber_muT, _Bool DEH_StEV_stRepEvent_mu8);
