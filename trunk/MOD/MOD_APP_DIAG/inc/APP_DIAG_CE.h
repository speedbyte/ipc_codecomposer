...
*/
/*-----------------------------------------------------------------------------
* $Date: 2011-02-03 07:57:35 +0100 (Do, 03 Feb 2011) $
* $Rev: 17637 $
* $Author: weber $
* $URL: http://subversion-01/svn/SW_HW_System/Projects/Ford_SCM/SW/MOD/MOD_APP_DIAG/trunk/inc/APP_DIAG_CE.h $
*-----------------------------------------------------------------------------
*/
/******************************************************************************/
...
*/
#define APP_DIAG_MAX_DATA_LENGTH	            33//ERM_MAX_NUM_USER_PROFILES *(AT_DEVICE_NAME_MAX_LEN+1)
...
#define APP_DIAG_DTC_CIRC_RES_OUT_OF_RANGE          0x40
