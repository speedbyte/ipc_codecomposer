""" 
    ...
    $Date: 2008-12-29 16:07:22 +0100 (Mo, 29 Dez 2008) $
    $Rev: 3524 $
    $Author: agrawal $
    $URL: http://subversion-01/svn/SW_HW_System/Projects/VW_UHV-NAR/SW/TOOLS/Python_scripts/trunk/KombiTextPrompts/sitecustomize.py $
...
'''
    This module ( imported from pydev/plugins will set the default encoding for python so 
    that it'll print things correctly to the console.
