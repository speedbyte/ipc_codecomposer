...
'MIKROFON_FUER_TELEFON_KURZSCHLUSS_NACH_MASSE' : [0x04, 0x04],
'MIKROFON_FUER_TELEFON_KURZSCHLUSS_NACH_PLUS' : [0x04, 0x04],
'MIKROFON_FUER_TELEFON_UNTERBRECHUNG' : [0x04, 0x04],
'STUMMSCHALTUNG_RADIO_KURZSCHLUSS_NACH_MASSE' : [0x04, 0x04],
'STUMMSCHALTUNG_RADIO_KURZSCHLUSS_NACH_PLUS' : [0x04, 0x04],
'STUMMSCHALTUNG_RADIO_UNTERBRECHUNG' : [0x04, 0x04],
'AUDIOKANAL_RECHTS_KURZSCHLUSS_NACH_MASSE' : [0x04, 0x04],
'AUDIOKANAL_RECHTS_KURZSCHLUSS_NACH_PLUS' : [0x04, 0x04],
'AUDIOKANAL_RECHTS_UNTERBRECHUNG' : [0x04, 0x04],
'AUDIOKANAL_RECHTS_KURZSCHLUSS_UNTEREINANDER' : [0x04, 0x04],
'AUDIOKANAL_LINKS_KURZSCHLUSS_NACH_MASSE' : [0x04, 0x04],
'AUDIOKANAL_LINKS_KURZSCHLUSS_NACH_PLUS' : [0x04, 0x04],
'AUDIOKANAL_LINKS_UNTERBRECHUNG' : [0x04, 0x04],
'AUDIOKANAL_LINKS_KURZSCHLUSS_UNTEREINANDER' : [0x04, 0x04],
'FUNKTIONSEINSCHRAENKUNG_DURCH_UEBERTEMPERATUR' : [0x05, 0x05],
'HALTERUNG_FUER_HANDYHALTER__BASEPLATE__KURZSCHLUSS_NACH_MASSE' : [0x05, 0x05],
'HALTERUNG_FUER_HANDYHALTER__BASEPLATE__KURZSCHLUSS_NACH_PLUS' : [0x05, 0x05],
'HALTERUNG_FUER_HANDYHALTER__BASEPLATE__UNTERBRECHUNG' : [0x05, 0x05],
'BEDIENEINHEIT_FUER_HANDYVORBEREITUNG__DREI_TASTEN_MODULE__MECHANISCHER_FEH__LER' : [0x05, 0x05],
'BEDIENEINHEIT_FUER_HANDYVORBEREITUNG__DREI_TASTEN_MODULE__KURZSCHLUSS_NACH_MASSE' : [0x05, 0x05],
'BEDIENEINHEIT_FUER_HANDYVORBEREITUNG__DREI_TASTEN_MODULE__KURZSCHLUSS_NACH_PLUS' : [0x05, 0x05],
'BEDIENEINHEIT_FUER_HANDYVORBEREITUNG__DREI_TASTEN_MODULE__UNTERBRECHUNG' : [0x05, 0x05],
'GSM_ANTENNE_KURZSCHLUSS_NACH_MASSE' : [0x05, 0x05],
'GSM_ANTENNE_UNTERBRECHUNG_KURZSCHLUSS_NACH_PLUS' : [0x05, 0x05],
'HANDYHALTER__CRADLE__MECHANISCHER_FEHLER' : [0x05, 0x05],
'STEUERGERAET_DEFEKT' : [0x00, 0x00],
'STEUERGERAET_DEFEKT_EEPROM_FEHLER' : [0x00, 0x00],
'STEUERGERAET_DEFEKT' : [0x00, 0x00],
'UNGUELTIGER_DATENSATZ' : [0x00, 0x00],
'DATENBUS_KOMFORT_DEFEKT' : [0x01, 0x01],
'DATENBUS_KOMFORT_KEINE_KOMMUNIKATION' : [0x01, 0x01],
'INFOTAINMENT_CAN_DEFEKT' : [0x06, 0x06],
'INFOTAINMENT_CAN_KEINE_KOMMUNIKATION' : [0x06, 0x06],
'BODYCOMPUTER_1__BORDNETZSTEUERGERAET___EL' : [0x14, 0x14],
'DIAGNOSE_INTERFACE_SG_KEINE_KOMMUNIKATION' : [0x14, 0x14],
'STEUERGERAET_FUER_SCHALTTAFELEINSATZ_KEINE_KOMMUNIKATION' : [0x15, 0x15],
'STEUERGERAET_FUER_LENKSAEULENELEKTRONIK_KEINE_KOMMUNIKATION' : [0x21, 0x21],
'VERSORGUNGSSPANNUNG_SPANNUNG_ZU_NIEDRIG' : [0x01, 0x01],
'VERSORGUNGSSPANNUNG_SPANNUNG_ZU_HOCH' : [0x01, 0x01],
'STEUERGERAET_NICHT_CODIERT' : [0x01, 0x01],
'STEUERGERAET_FALSCH_CODIERT' : [0x01, 0x01],
'STEUERGERAET_RADIO__RNS__KEIN_SIGNAL_KOMMUNIKATION' : [0x06, 0x06],
...
canmsg_dict_3 = {
'StopMsg' :             [[0xFF]],  
'IgnitionOn' :      [0x3C0, [0xFF,0xFF,0xFF,0xFF,0,0,0,0]],
'IgnitionOff' :     [0x3C0, [0x00,0,0,0,0,0,0,0]],
...
canmsg_dict_5 = {
'StopMsg' :     [[0xFF]],  
'ABschaltstufe_1' :      [0x663, [0x01,0,0,0,0,0,0,0]],
'Abschaltstufe_2' :     [0x663, [0x02,0,0,0,0,0,0,0]],
}
