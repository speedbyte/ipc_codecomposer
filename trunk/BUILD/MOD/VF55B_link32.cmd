...
*-----------------------------------------------------------------------------
* $Date: 2010-09-16 10:04:18 +0200 (Do, 16 Sep 2010) $
* $Rev: 15245 $
* $Author: agrawal $
...
MEMORY
{
    ...
    VECTORS1  (X)   :   origin=0x00000000   length=0x00000020    /* Arm Vector table : 32 bytes */
   	...
   	ROM       (RX)       : 	origin=0x00008024   length=0x000B7FD8  /* 736K - 40 bytes	   	 */
   	CHKS2     (R)        :  origin=0x000bfffc   length=0x00000004  fill=0x12345678  /* Checksum : 4 bytes */
   		/* ROM Table End */
   	FLASH_REQ (RW)  :   origin=0x00500000   length=0x00000004   /* RAM cell for flash request pattern : 4 bytes */   
   	RAM       (RW)  : 	origin=0x00500004   length=0x0000BFFC   /*  48K - 4 bytes              */    
   	/* dedicated RAM */
