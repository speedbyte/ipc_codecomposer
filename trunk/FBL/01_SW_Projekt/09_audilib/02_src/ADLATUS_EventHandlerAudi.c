...
| $HeadURL: http://smartsvn/svn/adlatusrepository/auslieferungen/S1NN/086350-S1NN-ADLATUS-TMS470R-MucSuc/20081201_S1NN_TMS470R_BlfIso-Source_V1.00/01_SW_Projekt/09_audilib/02_src/ADLATUS_EventHandlerAudi.c $
|
+------------------------------------------------------------------------------+
...
{ 
  ...
  /*--------------------------------------------------------------------------*/
  /* 0A */ d_CCeventaudi_SETFLAG___DefSessionRequ_UB,
...
void FUN_CCeventaudi_EventInit_V (void)
{
  ...
  t_CCeventaudi_PrjCtrl_ST.FlashCoreEntry_T16 = 0u;              /*  [OPL289] */
  t_CCeventaudi_PrjCtrl_ST.TimelockTimer_T16  = 0u;
...
void FUN__CCeventaudi_ProjectInitIntern_V (void)
{
  ...
  /* Init ProjectStateRegister                                                */ 
  t_CCeventaudi_PrjCtrl_ST.ProjectState_UB &= (d_CCeventaudi_TimelockRunning      |
                                               d_CCeventaudi_TimelockTimerElapsed | 
                                               d_CCeventaudi_ProjectStateInit);

  /* set special states */
  t_temp_UB =  (t_CCeventaudi_PrjCtrl_ST.EventRegister_AUB & \
                ( d_CCeventaudi_SETFLAG___FSWInvalid_UB | \
                  d_CCeventaudi_SETFLAG___Timelock_UB ));

  t_CCeventaudi_PrjCtrl_ST.EventRegister_AUB = t_temp_UB;            

  /* Init ProjectTimer                                                        */ 
  t_CCeventaudi_PrjCtrl_ST.FlashCoreEntry_T16 = (TIMER_16) c_CCconprj_StopCommResetTime_T16;
...
/*        FUN_CCcan_TxDiagResponse_V(d_CCconprj_DefSessionRspTG);  */
      ...
      /*======================================================================*/
      /* -3- Check the next event                                             */
      /*======================================================================*/
      else
      {
        /*====================================================================*/
        /* -4- A flash request had been received                              */
        /*====================================================================*/
        if (d_CCeventaudi_SETFLAG___FlashRequest_UB == (d_CCeventaudi_SETFLAG___FlashRequest_UB & \
                            t_CCeventaudi_PrjCtrl_ST.EventRegister_AUB))
        {
          /* Reset Flag                                                      */
          t_CCeventaudi_PrjCtrl_ST.EventRegister_AUB &= d_CCeventaudi_RESETFLAG_FlashRequest_UB; 

          /*------------------------------------------------------------------*/
          /* send positiv response for session control programming session    */
          /*------------------------------------------------------------------*/
/*          FUN_CCcan_TxDiagResponse_V(d_CCconprj_SessionCtrlRspTG);  */
        ...
        /*====================================================================*/
        /* -4- Check the next event                                           */
        /*====================================================================*/
        else
        {
          /*====================================================================*/
          /* -5- FlashCore Entry Timer elapsed                                  */
          /*====================================================================*/
          if ( d_CCeventaudi_FlashCoreEntryTimerElapsed == \
              (t_CCeventaudi_PrjCtrl_ST.ProjectState_UB & d_CCeventaudi_FlashCoreEntryTimerElapsed))
          {
            t_CCeventaudi_PrjCtrl_ST.ProjectState_UB &= ~d_CCeventaudi_FlashCoreEntryTimerElapsed; /*[OPL-310] */
            /* reset the system if we are in a non default session and communication */
            /* has stopped                                                           */
            if (d_CCeventaudi_SETFLAG___OpenChannel_UB == \
               (t_CCeventaudi_PrjCtrl_ST.EventRegister_AUB & d_CCeventaudi_SETFLAG___OpenChannel_UB)) 
            {
              /*--------------------------------------------------------------------*/
              /* Reset the flash request                                            */
              /*--------------------------------------------------------------------*/
              FUN_CCapplint_ResetFlashRequest_V();
...
/*              FUN_CCkwpaudi_ClearFlashFunctions_V();  */
          ...
          {
            /* look for a running timelock */
            if (d_CCeventaudi_SETFLAG___Timelock_UB == (d_CCeventaudi_SETFLAG___Timelock_UB & \
                                  t_CCeventaudi_PrjCtrl_ST.EventRegister_AUB))
            {
                                  ...
                                  t_CCeventaudi_PrjCtrl_ST.ProjectState_UB))
              {
                ...
                /* remember setting of timer */
                t_CCeventaudi_PrjCtrl_ST.ProjectState_UB |= d_CCeventaudi_TimelockRunning;
              }
              else
              {
                /* if timer is running -- look for expiring */
                if(d_CCeventaudi_TimelockTimerElapsed == (t_CCeventaudi_PrjCtrl_ST.ProjectState_UB & \
                                           d_CCeventaudi_TimelockTimerElapsed))
                {
                  /* reset timelock */
                  t_CCeventaudi_PrjCtrl_ST.EventRegister_AUB &= d_CCeventaudi_RESETFLAG_Timelock_UB; 

                  t_CCeventaudi_PrjCtrl_ST.ProjectState_UB &= ~d_CCeventaudi_TimelockRunning;      /*  [OPL289] */
                  t_CCeventaudi_PrjCtrl_ST.ProjectState_UB &= ~d_CCeventaudi_TimelockTimerElapsed; /*[OPL-310] */
             
                  /* reset all locks */
/*                  sECUDataAppl_ST.SecAccess_UB = 0x00u; */

                  /* change eeprom info */
/*                  FUN_CCnvm_NvmAccess_UB (d_CCnvm_WRITE_TIMELOCK,&sECUDataAppl_ST.SecAccess_UB ); */
                }
              }
            }
            /*================================================================*/
            /* -6- Check the next event                                       */
            /*================================================================*/
            else
            {
